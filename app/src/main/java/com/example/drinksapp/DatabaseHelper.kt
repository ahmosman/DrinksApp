...
//        copyDatabase(context)
    ...
    private fun loadCocktails() {
        ...
        val cursor = db.rawQuery("SELECT cocktail_id, name, recipe, image, category FROM cocktails", null)
        cursor.use {
            while (it.moveToNext()) {
                val id = it.getInt(0)
                ...
                cocktails.add(Cocktail(id, name, category, image, recipe, ingredients))
            }
        }
    }
